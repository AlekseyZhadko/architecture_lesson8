...
public class BookingPresenter implements ViewObserver {
    ...
    public void ChangeReservationTableResult(int reservationNo, int oldReservationNo) {
        view.showChangeReservationTableResult(reservationNo, oldReservationNo);
    }


    public void ChageReservationTable(int oldReservationNo, Date orderDate, int tableNo, String name) {
        try {
            int reservationNo = model.reservationTable(orderDate, tableNo, name);
            ChangeReservationTableResult(reservationNo, oldReservationNo);
